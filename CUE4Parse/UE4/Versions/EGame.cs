...
public enum EGame : uint
{
    ...
    GAME_UE5_1 = GameUtils.GameUe5Base + (1 << 16),
        ...
        GAME_WorldofJadeDynasty = GAME_UE5_1 + 7,
    ...
    GAME_UE5_4 = GameUtils.GameUe5Base + (4 << 16),
        ...
        GAME_2XKO = GAME_UE5_4 + 15,
        GAME_Reanimal = GAME_UE5_4 + 16,
        GAME_VEIN = GAME_UE5_4 + 17,
        GAME_Placeholder2 = GAME_UE5_4 + 18,
        GAME_OuterWorlds2 = GAME_UE5_4 + 19,
        GAME_OctopathTraveler0 = GAME_UE5_4 + 20,
        GAME_CodeVein2 = GAME_UE5_4 + 21,
